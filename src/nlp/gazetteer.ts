...
//
// Reads plain text files under data/gazetteer/{organization,location}.txt
...
//
// event.txt / thing.txt are no longer loaded: those categories are now
// sourced from the NER "misc" tag instead of a curated list.
//
